...
import { Card, CardHeader, CardBody, Button, ButtonGroup, Radio, RadioGroup, Input } from "@heroui/react";
...
const CheckoutPage = () => {
    ...
    const handleOrder = () => {
        ...
        if (selectedPaymentMethod === "bank_transfer") {
            navigate("/payment", { state: { items, selectedAddress, deliveryMethod: selectedDeliveryMethod } });
            return;
        } 
        ...
        if (selectedPaymentMethod === "international_card") {
            ...
            if (hasErrors) {
                // Tìm trường đầu tiên có lỗi và focus vào nó
                ...
                console.error("Vui lòng kiểm tra lại thông tin thẻ");
                
                // Không cho phép tiếp tục
                return;
            }
            
            // Không có lỗi - tiếp tục xử lý thanh toán
            console.log("Thông tin thẻ hợp lệ, tiến hành thanh toán...");
            ...
            // try {
            //     const result = await processPayment(cardInfo);
            //     if (result.success) {
        ...
        // Chuyển đến trang thành công (cho các phương thức khác)
        navigate("/order-success");
    };
                    ...
                    <Card>
                        ...
                        <CardBody className="p-6">
                            ...
                            <div className="space-y-7">
                                ...
                                {selectedDeliveryMethod === "pharmacy" && (
                                    <p className="text-sm text-gray-500 italic">
                                        <span className="font-bold">Dự kiến giao hàng:</span> 4 - 7 ngày không bao gồm
                                        thứ 7, chủ nhật
                                    </p>
                                )}
                            </div>
                        ...
                        <CardBody className="p-6 pt-0 space-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className="font-semibold text-gray-900">
                                    {items
                                        .reduce(
                                            (total, item) => total + item.selectedVariant.current_price * item.quantity,
                                            0
                                        )
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className="font-semibold text-sky-600">
                                    ...
                                    {items
                                        .reduce((total, item) => {
                                            const discount = item.selectedVariant.original_price
                                                ? (item.selectedVariant.original_price -
                                                      item.selectedVariant.current_price) *
                                                  item.quantity
                                                : 0;
                                ...
                                <div className="flex justify-between items-end pt-2">
                                    ...
                                    <span className="text-3xl font-bold text-red-500">
                                        {items
                                            .reduce(
                                                (total, item) =>
                                                    total + item.selectedVariant.current_price * item.quantity,
                                                0
                                            )
                                            .toLocaleString("vi-VN")}
                                        đ
                            ...
                            <div className="text-[13px] text-gray-500 text-center leading-relaxed">
                                ...
                                <p>
                                    <span className="text-sky-600 underline cursor-pointer">Điều khoản dịch vụ</span>{" "}
